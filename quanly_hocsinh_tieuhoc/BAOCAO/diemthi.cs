...
namespace quanly_hocsinh_tieuhoc
{
    public partial class diemthi : Form
    {
        ...
        private void diemthi_Load(object sender, EventArgs e)
        {
            ...
            //////////////////////////////////////
            DataTable cbmamon = DatabaseService.DatabaseService.getDataTable("select * from DS_MONHOC WHERE loai_mon_hoc = N'Văn hóa' OR loai_mon_hoc = 'Đánh giá'");
        ...
        {
            string xemdiem = "Select * from DIEM_THI where nam_hoc ='" + cbNamhoc.Text + "' and ten_lop =N'" + cbLop.Text + "'and mon_hoc =N'" + cbMonHoc.Text + "'";
        ...
        {
            string searchname = "Select * from DIEM_THI where ho_ten like N'%" + txtTimhs.Text + "%' AND nam_hoc='"+cbNamhoc.Text+"' AND ten_lop = '"+cbLop.Text+"' AND mon_hoc = N'"+cbMonHoc.Text+"'";
            try
            {
